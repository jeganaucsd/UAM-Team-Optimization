...
from lsdo_aircraft-master.lsdo_aircraft.api import Preprocess, Atmosphere, Powertrain, PowertrainGroup, AtmosphereGroup
from lsdo_aircraft-master.lsdo_aircraft.api import SimpleRotor, SimpleMotor
