...
# cl for section of the wing that is NOT affected by propeller slip stream
    def setup(self):
        ...
        self.add_input('average_wing_axial_int_fac')
        ...
        self.declare_partials('wing_CL','average_wing_axial_int_fac')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['wing_CL'] = (wing_CLa * wing_alpha + wing_CL0) + (wing_CLa * wing_alpha + wing_CL0)*wing_blown_percent*((1+average_wing_axial_int_fac)**2 - 1)
