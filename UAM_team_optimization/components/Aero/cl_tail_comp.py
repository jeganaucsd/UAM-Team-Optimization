...
# cl for section of the tail that is NOT affected by propeller slip stream
    def setup(self):
        ...
        self.add_input('average_tail_axial_int_fac')
        ...
        self.declare_partials('tail_CL','average_tail_axial_int_fac')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['tail_CL'] = (tail_CLa * tail_alpha + tail_CL0) + (tail_CLa * tail_alpha + tail_CL0)*tail_blown_percent*((1+average_tail_axial_int_fac)**2 - 1)
